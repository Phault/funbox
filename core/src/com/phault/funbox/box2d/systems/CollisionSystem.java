package com.phault.funbox.box2d.systems;
...
import com.phault.funbox.box2d.components.FixtureComponent;
...
public class CollisionSystem extends BaseEntitySystem implements ContactListener, WorldTransformationManager.TransformationChangedListener {
    ...
    private com.phault.funbox.scenegraph.systems.WorldTransformationManager transformManager;
    ...
    public CollisionSystem() {
        super(Aspect.all(com.phault.funbox.scenegraph.components.Transform.class, Rigidbody.class));
        Box2D.init();
