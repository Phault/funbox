package com.phault.funbox.hierarchy.systems;
...
import com.phault.funbox.hierarchy.components.Children;
import com.phault.funbox.hierarchy.components.Parented;
...
public class HierarchyManager extends BaseEntitySystem implements LinkListener {
    ...
    private Bag<HierarchyChangedListener> listeners = new Bag<HierarchyChangedListener>();
